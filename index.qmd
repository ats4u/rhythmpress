...
def create_toc_v1( input_md, output_md, link_target_md ):
...
with open( 'beat-orientation/master-ja.qmd', encoding='utf-8') as f:
  result = rhythmpedia.parse_qmd_teasers( f.read() )
...
create_toc_v1( input_md, output_md, link_target_md )
```
### <ruby><rb>多層弱拍基軸律動</rb><rt>グルーヴィダンスミュージック</rt></ruby>理論 {#多層弱拍基軸律動理論}
- [**<ruby><rb>多層弱拍基軸律動</rb><rt>グルーヴィダンスミュージック</rt></ruby>理論**](./beat-orientation/index.md)  
