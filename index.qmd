...
オフビートカウント理論を核に据えた統合グルーヴ理論です ─── オフビートカウントとは何でしょうか。そして何故生まれたのでしょうか。オフビートカウント及び、オフビートカウントを構成する６つの理論との関係を説明します。
...
link_target = "tatenori-theory/index.md"
...
link_target  = "beat-orientation/index.md"
