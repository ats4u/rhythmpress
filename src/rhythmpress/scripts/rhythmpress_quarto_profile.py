...
GENERATED_FILE_NOTICE = (
    ...
    "# This file is automatically generated by Rhythmpress.\n"
    "# Any manual changes made here will be overwritten the next time the profile is generated.\n"
    "# To make persistent changes, edit the source files (for example: _quarto.yml, "
    "_metadata-<lang>.yml, and generated-sidebar inputs), then regenerate.\n"
)
...
def serialize_yaml(data: Dict[str, Any]) -> str:
    ...
    if not dumped.endswith("\n"):
        dumped += "\n"
    return f"{GENERATED_FILE_NOTICE}\n{dumped}"
