...
#### まとめ
* １．テンポのある曲では「音が一音しかないということはありえない」という点を認識する。
    * → 音が一音しかなかった場合、それはリズムとして成立せずテンポも存在しない。
        * → だからもしもテンポがある曲なら音は必ず二音以上ある。
            * → ではその２音はどの様な長さでどの拍にあるのかを考える必要がある。
* ２． 音がニ音あった時の難しさを認識させる。
    * → 音がニ音あった場合、片方は必ず弱拍である事を意味する。
        * → 二音あるとき、最初の音が強拍だった場合と弱拍だった場合の違いを考える。
            * → 最初の音が強拍だったと仮定すると、それは１拍目強拍でしかありえない。何故か。
                * → もしもそれが２拍目と４拍目だったら裏拍ということになる。
                * → もしもそれが４分音符３拍目強拍だったとしたら、それは２分音符の裏拍ということになる。
            * → 最初の音が弱拍だったとすると、それは全音符２分音符４分音符８分音符１６分音符・・・全ての音価の裏拍という可能性がある。
            * → つまり全ての音価の裏拍だった可能性と、表拍である可能性を考える必要がある。
