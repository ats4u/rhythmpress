...
前節で見た様に、シラブル拍リズムは、**全てのシラブルが基本的に等間隔に置かれる**というルールが存在します。しかしストレス拍リズムでは、シラブルの中でも **強勢拍(ストレス拍)** のある音節だけが一定の時間間隔で配置されまる。 それ以外のシラブルは**弱勢拍(無ストレス拍)** と呼ばれ、短く発音されます。 この**ストレス拍リズムの弱勢拍の省略こそがシラブル拍リズムとの大きな違いになっており、ストレス拍リズムの大きな特徴** になっています。
